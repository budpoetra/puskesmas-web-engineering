...
<body class="theme-cyan">
                    ...
                    <div class="tab-pane active" id="menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <li class="active"><a href="pembayaran.php"><i class="icon-list"></i>Pembayaran</a></li>
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            <form method="post" action="../../config/pembayaran.php ">
                                                ...
                                                ?>
                                                <select id="t_nama_pasien" name="t_namapasien" class="form-control show-tick">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                ?>
                                                <select id="t_poli" name="t_tipepoli" class="form-control show-tick">
                                                    <?php while($row = $data->fetch_array()){
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                $data = mysqli_query($koneksi,"select * from data_poli");
                                                ?>
                                                <select id="t_dokter" name="t_namadr" class="form-control show-tick">
                                                    <?php while($row = $data->fetch_array()){
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="t_total" name="t_total"
                                                        class="form-control" placeholder="Total Pembayaran">
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label>Keterangan</label>
                                                    <input type="text" id="t_keterangan" name="t_keterangan"
 ...
 <!-- Javascript -->
    ...
    <script src="../../assets/admin/bundles/flotscripts.bundle.js"></script>
