                ...
                <div class="tab-pane active" id="menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="registrasi_pasien.php"><i class="icon-list"></i>Registrasi Pasien</a></li></li>
                            <li><a href="data_pasien.php"><i class="icon-list"></i>Data Pasien</a></li></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"></a> Registrasi Pasien</h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <p class="float-md-left">
                                    <a href="registrasi_pasien-tambah.php"><span class="badge badge-info">+ Registrasi Pasien</span></a>
                                </p>
                                <div class="table-responsive table_middel">
                                    <table class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM registrasi_pasien ");
                                            
                                            while($data = $query->fetch_object()){; 
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><span><?php echo $data->nama_pasien; ?></span></td>
                                                <td><span><?php echo $data->tipe_poli; ?></span></td>
                                                <td><span><?php echo $data->nama_dr; ?></span></td>
                                                <td><span><?php echo $data->tgl_berobat; ?></span></td>
                                                <td><a href="detail_registrasi_pasien.php?id=<?php echo $data->id; ?>"> Detail</a></td>
                                            </tr>
                                            <?php
                                          }
                                          ?>
