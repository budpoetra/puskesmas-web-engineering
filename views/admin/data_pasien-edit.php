            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        ?>
                            <form id="formEditDataPasien" method="post" action="../../config/editDataPasien.php">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" id="password" name="password" class="form-control" placeholder="Enter Password Baru">
                                                    <small class="form-text text-danger">Kosongkan kolom ini jika tidak ingin merubah password.</small>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="password2">Confirmation Password Baru</label>
                                                    <input type="password" id="password2" name="password2" class="form-control" placeholder="Enter Confirmation Password Baru">
                                                    <small class="form-text text-danger">Kosongkan kolom ini jika tidak ingin merubah password.</small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" id="no_identitas" name="no_identitas" class="form-control" value="<?= $data->no_identitas; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama">Nama Lengkap</label>
                                                <input type="text" id="nama" name="nama" class="form-control" value="<?= $data->nama_lengkap; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama_ortu">Nama Orang Tua</label>
                                                <input type="text" id="nama_ortu" name="nama_ortu" class="form-control" value="<?= $data->nama_orang_tua; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="tempat_lahir">Tempat Lahir</label>
                                                <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" value="<?= $data->tempat_lahir; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="agama" name="agama" class="form-control show-tick" required>
                                                    ...
                                                    <option <?php if ($data->agama == 'Protestan') {
                                                                echo 'selected';
                                                    ...
                                                    <option <?php if ($data->agama == 'Buddha') {
                                                                echo 'selected';
                                                            } ?> value="Buddha">Buddha</option>
                                                    <option <?php if ($data->agama == 'Khonghucu') {
                                                                echo 'selected';
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="alamat" name="alamat" class="form-control" value="<?= $data->alamat; ?>" required></input>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="bpjs">BPJS</label>
                                                <input type="text" id="bpjs" name="bpjs" class="form-control" value="<?= $data->bpjs; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="goldar">Golongan Darah</label>
                                                <input type="text" id="goldar" name="goldar" class="form-control" value="<?= $data->goldar; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="gender" name="gender" class="form-control show-tick">
                                                    <?php
                                                    if ($data->gender == "Perempuan" or $data->gender == "perempuan") {
                                        ...
                                        <div class="col-sm-12">
                                            <button type="submit" id="btnEditDataPasien" class="btn btn-primary">Edit Data</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
