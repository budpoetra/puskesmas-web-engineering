                        ...
                        <div class="card">
                            <div class="body">
                                <p class="float-md-left">
                                    <a href="data_pengguna-tambah.php"><span class=" badge badge-info">+ Tambah Data
                                            Pengguna</span></a>
                                </p>
                                <div class="table-responsive table_middel">
                                    <table id="table" class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM data_pengguna");

                                            while ($data = $query->fetch_object()) {
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><img src="../../assets/image/<?php echo $data->photo; ?>" alt="Photo" width="50"></td>
                                                    <td><span><?php echo $data->nama; ?></span></td>
                                                    <td><span><?php echo ucfirst($data->tempat_lahir) . ", " . date('d F Y', strtotime($data->tgl_lahir)); ?></span></td>
                                                    <td><span><?php echo $data->no_telp; ?></span></td>
                                                    <td><span><?php echo ucfirst($data->alamat); ?></span></td>
                                                    <td><span><?php echo ucfirst($data->spesialis); ?></span></td>
                                                    <td><span><?php echo $data->gender; ?></span></td>
                                                    <td><span><?php echo ucfirst($data->jabatan); ?></span></td>
                                                    <td><a href="data_pengguna-detail.php?id=<?= $data->id_pengguna; ?>" class="btnDetail">
                                                        ...
                                                        <a href="data_pengguna-edit.php?id=<?= $data->id_pengguna; ?>" class="btnEdit">
                                                        ...
                                                        <button type="button" id="btnHapusDataPengguna" class="btn btn-danger" data-id="<?= $data->id_pengguna; ?>">
