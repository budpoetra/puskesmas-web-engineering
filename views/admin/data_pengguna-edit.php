...
<<<<<<< HEAD
                                <li class="active"><a href="data_pengguna.php"><i class="icon-calendar"></i>Data Pengguna</a></li>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        $query = $koneksi->query("SELECT `login_user`.`email`, `data_pengguna`.* FROM `login_user` INNER JOIN `data_pengguna` WHERE `login_user`.`id_pengguna` = `data_pengguna`.`id_pengguna` AND `data_pengguna`.`id_pengguna` = $id_pengguna");

                        while ($data = $query->fetch_object()) {
                        ?>
                            <form id="formEditDataPengguna" method="post" action="../../config/admin_aksi.php" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= ucfirst($data->jabatan); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" id="no_tlp" name="no_tlp" class="form-control" value="<?= $data->no_telp; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="spesialis">Spesialis</label>
                                                <input type="text" id="spesialis" name="spesialis" class="form-control" value="<?= $data->spesialis; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
