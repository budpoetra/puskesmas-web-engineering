                        ...
                        ?>
                            <form method="post" action="">
                                <div class="body">
                                    ...
                                    <hr>
                                    <h4>Data Pengguna</h4>
                                    <img src="../../assets/image/<?php echo $data->photo; ?>" alt="Photo" width="150" class="rounded mx-auto d-block">
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama" name="nama" class="form-control" value="<?= $data->nama; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" id="no_tlp" name="no_tlp" class="form-control" value="<?= $data->no_telp; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="spesialis">Spesialis</label>
                                                <input type="text" id="spesialis" name="spesialis" class="form-control" value="<?= $data->spesialis; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
