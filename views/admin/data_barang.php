...
<<<<<<< HEAD
                                <li><a href=""><i class="icon-list"></i>Laporan</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="#">Laporan Rujukan</a></li>
                                    </ul>
                                </li>
                                <li><a href="data_pengguna.php"><i class="icon-calendar"></i>Data Pengguna</a></li>
                                <li class="active"><a href="#"><i class="icon-list"></i>Kefarmasian</a>
=======
                                ...
                                <li class="active"><a href="#"><i class="icon-notebook"></i>Kefarmasian</a>
>>>>>>> 9cde80019631cc9d16fee030b77b73964611b9a3
                                    <ul class="dropdown">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Kefarmasian</li>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="body">
                            <p id="btnTambahDataBarang" class="float-md-left">
                                <a href="javascript:void(0)"><span class="badge badge-info">+ Tambah Data Barang</span></a>
                            </p>
                                ...
                                <table id="table" class="table m-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><span><?php echo $data->kode_barang; ?></span></td>
                                                <td><span><?php echo $data->nama_barang; ?></span></td>
                                                <td><span><?php echo 'Rp. ' . number_format($data->harga_jual, 0, ',', '.'); ?></span></td>
                                                <td>
                                                    <button type="button" id="btnEditDataBarang" class="btn btn-warning" data-kode="<?php echo $data->kode_barang; ?>" data-nama="<?php echo $data->nama_barang; ?>" data-harga="<?php echo $data->harga_jual; ?>">
                                                    ...
                                                    <button type="button" id="btnHapusDataBarang" class="btn btn-danger" data-id="<?php echo $data->id_barang; ?>">
