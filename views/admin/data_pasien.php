                    ...
                    <div class="card shadow">
                        <div class="body">
                            <p class="float-md-left">
                                <a href="data_pasien-tambah.php"><span class="badge badge-info">+ Tambah Data Pasien</span></a>
                            </p>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="data_pasien-detail.php?id=<?= $data->id_pasien; ?>">
                                                    ...
                                                    <a href="data_pasien-edit.php?id=<?= $data->id_pasien; ?>">
                                                    ...
                                                    <button type="button" id="btnHapusDataPasien" class="btn btn-danger" data-id="<?= $data->id_pasien; ?>">
