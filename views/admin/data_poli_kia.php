                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2>Poli Kesehatan Ibu dan Anak</h2>
                            <ul class="breadcrumb">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="body">
                                <p id="btnTambahDataPoli" class="float-md-left" data-poli="kia">
                                ...
                                <div class="table-responsive table_middel">
                                    <table id="table" class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM pemeriksaan WHERE kategori = \"kia\"");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" id="btnEditDataPoli" class="btn btn-warning" data-id="<?php echo $data->id_pemeriksaan; ?>" data-poli="kia" data-pemeriksaan="<?php echo $data->pemeriksaan; ?>" data-tarif="<?php echo $data->tarif; ?>">
                                                        ...
                                                        <button type="button" id="btnHapusDataPoli" class="btn btn-danger" data-poli="kia" data-id="<?php echo $data->id_pemeriksaan; ?>">
