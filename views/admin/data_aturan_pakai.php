                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Data Aturan Pakai</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="body">
                            <p id="btnTambahDataAturan" class="float-md-left">
                                <a href="javascript:void(0)"><span class="badge badge-info">+ Tambah Data Aturan Pakai</span></a>
                            </p>
                            <div class="table-responsive table_middel">
                                <table id="table" class="table m-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        $query = $koneksi->query("SELECT * FROM aturan_pakai");

                                        while ($data = $query->fetch_object()) {;
                                        ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><span><?php echo $data->aturan; ?></span></td>
                                                <td>
                                                    <button type="button" id="btnEditDataAturan" class="btn btn-warning" data-id="<?php echo $data->id_aturan_pakai; ?>" data-aturan="<?php echo $data->aturan; ?>">
                                                    ...
                                                    <button type="button" id="btnHapusDataAturan" class="btn btn-danger" data-id="<?php echo $data->id_aturan_pakai; ?>">
