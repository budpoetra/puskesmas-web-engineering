...
<<<<<<< HEAD
                                <li class="active"><a href="#"><i class="icon-list"></i>Data Pemeriksaan</a>
=======
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Data Pemeriksaan</li>
                                <li class="breadcrumb-item active">Poli Lansia</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="body">
                                <p id="btnTambahDataPoli" class="float-md-left" data-poli="lansia">
                                ...
                                <div class="table-responsive table_middel">
                                    <table id="table" class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM pemeriksaan WHERE kategori = 'lansia'");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" id="btnEditDataPoli" class="btn btn-warning" data-poli="lansia" data-id="<?php echo $data->id_pemeriksaan; ?>" data-poli="lansia" data-pemeriksaan="<?php echo $data->pemeriksaan; ?>" data-tarif="<?php echo $data->tarif; ?>">
                                                        ...
                                                        <button type="button" id="btnHapusDataPoli" class="btn btn-danger" data-poli="lansia" data-id="<?php echo $data->id_pemeriksaan; ?>">
