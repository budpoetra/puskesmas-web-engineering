                        ...
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <!-- <li><a href="javascript:void(0);" class="has-arrow"><i
                                            class="icon-user-follow"></i><span>Data User</span> </a>
                                    <ul>
                                        <li><a href="doctors-all.html">Dokter</a></li>
                                        <li><a href="data_resepsionis.php">Resepsionis</a></li>
                                    </ul>
                                </li> -->
                            </ul>
                        </nav>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <p class="float-md-left">
                                    <a href="data_poli-tambah.php"><span class="badge badge-info">+ Tambah Data
                                            Poli</span></a>
                                </p>
                                <div class="table-responsive table_middel">
                                    <table class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM data_poli");
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edit_data_poli.php?id=<?php echo $data->id; ?>">Edit</a><a href="detail_data_poli.php?id=<?php echo $data->id; ?>"> Detail</a></td>
                                            </tr>
                                            <?php
                                          }
                                          ?>
