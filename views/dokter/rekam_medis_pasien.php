                    ...
                    <div class="tab-pane active" id="menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <li class="active"><a href="rekam_medis_pasien.php"><i class="icon-list"></i>Rekam Medis
                                        Pasien</a></li>
                                <li><a href="rekap_pasien.php"><i class="icon-home"></i>Rekap Pasien</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <table class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span><?php echo $data->keluhan; ?></span></td>
                                                <td><span><?php echo $data->tipe_poli; ?></span></td>
                                                <td><span><?php echo $data->nama_dr; ?></span></td>
                                                <td><span><?php echo $data->tgl_berobat; ?></span></td>
                                                <!-- <td><a
                                                        href="edit_data_pasien.php?id=<?php echo $data->id; ?>">Edit</a><a
                                                        href="detail_data_pasien.php?id=<?php echo $data->id; ?>">
                                                        Detail</a>
                                                </td> -->
                                            </tr>
                                            <?php
