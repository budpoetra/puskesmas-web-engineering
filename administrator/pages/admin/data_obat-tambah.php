                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <form method="post" action="../../config/tambah-obat.php">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" min="0" id="t_tipeobat" name="t_tipeobat" class="form-control"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type=date id="t_tglexp" name="t_tglexp" class="form-control show-tick"
                                            placeholder="Tanggal Exp">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Tanggal Masuk</label>
                                        <input type=date id="t_tglmsk" name="t_tglmsk" class="form-control show-tick"
