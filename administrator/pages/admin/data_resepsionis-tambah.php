                    ...
                    <div class="tab-pane active" id="menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <li><a href="#"><i class="icon-list"></i>Data Obat</a></li>
                                <li class="active"><a href="data_pasien.php"><i class="icon-home"></i>Data Pasien</a>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Tambah Data Resepsionis</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <form method="post" action="../../../config/tambah-pasien.php">
