                    ...
                    <div class="tab-pane active" id="menu">
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu">
                                ...
                                <li><a href="data_pasien.php"><i class="icon-user"></i>Data Pasien</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow">
                            <div class="card-header">
                                ...
                                <a href="../pdf/pdf-laporan_rekam_medis_detail.php?id_registrasi=<?= $id_registrasi ?>" target="_blank">
                            ...
                            <br>
                            <?php
                            $query2 = $koneksi->query("SELECT * FROM registrasi INNER JOIN pasien ON `registrasi`.id_pasien = `pasien`.id_pasien WHERE id_registrasi = $id_registrasi");
