...
<head>
    ...
    <link rel="icon" href="../../../administrator/assets/Logo.png" type="image/x-icon">
    <!-- VENDOR CSS -->
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <p class="float-md-left">
                                    <a href="data_obat-tambah.php"><span class="badge badge-info">+ Tambah Data
                                            Obat</span></a>
                                </p>
                                <div class="table-responsive table_middel">
                                    <table class="table m-b-0">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $query = $koneksi->query("SELECT * FROM data_obat");
                                            
                                            while($data = $query->fetch_object()){; 
                                            ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                <td><span><?php echo $data->nama_obat; ?></span></td>
                                                <td><span><?php echo $data->tipe_obat; ?></span></td>
                                                <td><span><?php echo $data->tgl_exp; ?></span></td>
                                                <td><span><?php echo $data->tgl_masuk; ?></span></td>
                                                <td><a href="edit_data_obat.php?id=<?php echo $data->id; ?>">Edit</a><a href="detail_data_obat.php?id=<?php echo $data->id; ?>"> Detail</a></td>
                                            </tr>
                                            <?php
                                          }
                                          ?>
