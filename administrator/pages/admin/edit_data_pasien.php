...
<body class="theme-cyan">
	...
	while($d = mysqli_fetch_array($data)){
		?>
                                    ...
                                    <form method="post" action="../../config/update_pasien.php">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" id="t_notelp" name="t_notelp" class="form-control"
                                            value="<?php echo $d['no_hp']; ?>" placeholder="Nomor Telepon">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="t_tempatlahir" name="t_tempatlahir" class="form-control"
                                            value="<?php echo $d['tempat_lahir']; ?>" placeholder="Tempat Lahir">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
