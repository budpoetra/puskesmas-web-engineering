...
if ($_GET['id_pasien'] and $_GET['poli']) {
  $id_pasien = $_GET['id_pasien'];
  $poli = $_GET['poli'];
} else {
  header('Location: ../resepsionis/registrasi.php?pesan=gagal');
}
...
<body class="d-flex flex-column h-100">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      let poli = $('#poli').val();
      $('#antrian').load('get_antrian.php?poli=' + poli);
        ...
        $.ajax({
          ...
          success: function(result) { // ketika proses insert data selesai
            ...
            if (result.status == 'success') {
              window.location.href = '../../../views/resepsionis/registrasi.php?pesan=berhasil';
            } else {
              window.location.href = '../../../views/resepsionis/registrasi.php?pesan=gagal';
            }
          },
        });
      });
