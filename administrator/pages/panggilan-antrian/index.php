...
if ($_GET['poli']) {
  ...
  header('Location: ../resepsionis/index.php?pesan=gagal');
}
...
<body class="d-flex flex-column h-100">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-4">
      <a href="../resepsionis/index.php">
        <button type="button" class="btn btn-secondary">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="27" fill="white" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#jumlah-antrian').load('get_jumlah_antrian.php?poli=' + poli);
      $('#antrian-sekarang').load('get_antrian_sekarang.php?poli=' + poli);
      $('#antrian-selanjutnya').load('get_antrian_selanjutnya.php?poli=' + poli);
      $('#sisa-antrian').load('get_sisa_antrian.php?poli=' + poli);
      ...
      var table = $('#tabel-antrian').DataTable({
        ...
        "ajax": "get_antrian.php?poli=" + poli, // url file proses tampil data dari database
        // menampilkan data
        "columns": [{
            "data": "no_antrian",
            "width": '250px',
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Poli" + poli + ", Nomor Antrian, " + data["no_antrian"] + ", menuju ruangan", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
        ...
        $.ajax({
          ...
          url: "update.php?poli=" + poli, // url file proses update data
          data: {
            id: id
      ...
      setInterval(function() {
        $('#jumlah-antrian').load('get_jumlah_antrian.php?poli=' + poli).fadeIn("slow");
        $('#antrian-sekarang').load('get_antrian_sekarang.php?poli=' + poli).fadeIn("slow");
        $('#antrian-selanjutnya').load('get_antrian_selanjutnya.php?poli=' + poli).fadeIn("slow");
        $('#sisa-antrian').load('get_sisa_antrian.php?poli=' + poli).fadeIn("slow");
