                        ...
                        <div class="card shadow">
                            <div class="card-header">
                                <div class="row justify-content-between">
                                    <div class="col-4">
                                        <a href="riwayat_pemeriksaan.php">
                                        ...
                                        <a href="../pdf/pdf-laporan_rekam_medis.php?id_pasien=<?= $id_pasien ?>" target="_blank">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="riwayat_pemeriksaan-detail.php?id=<?php echo $data->id_registrasi; ?>">
