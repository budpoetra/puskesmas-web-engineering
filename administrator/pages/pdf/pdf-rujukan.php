...
$html =
    '<html>
    <head>
    <title>' . 'Rujukan_' .  $data['nama_lengkap'] . '_' . date('d F Y', strtotime($data['tgl_regis'])) . '</title>
    <meta charset="utf-8">
        ...
        <table class="table table-borderless">
            <tbody>
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="4">' .  $data['rs_rujukan'] . '</td>
                </tr>
                <tr>
...
$dompdf->stream('Rujukan_' .  $data['nama_lengkap'] . '_' . date('d F Y', strtotime($data['tgl_regis'])), array('Attachment' => false));
