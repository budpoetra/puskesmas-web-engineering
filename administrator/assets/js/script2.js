$(function () {
    ...
    $(document).on('click', '#btnEditDataPoli', function(e) {
        ...
        $('.modal-body').html('<input type="hidden" name="poli" id="poli"><input type="hidden" name="id_pemeriksaan" id="id_pemeriksaan"><label for="pemeriksaan" class="form-label">Pemeriksaan</label><input type="text" class="form-control" id="pemeriksaan" name="pemeriksaan" required></div><div class="mb-3"><label for="tarif" class="form-label">Tarif</label><input type="number" class="form-control" id="tarif" name="tarif" required></div>');
        $('#poli').val(poli);
                    ...
                    success: function(r) {
                        if(r.status == 'success') {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    document.location.href = 'data_poli_' + poli + '.php';
                                }
                            });
                        } else {
                            Swal.fire({
                    ...
                    success: function(r) {
                        if(r.status == 'success') {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    document.location.href = 'data_aturan_pakai.php';
                                }
                            });
                        } else {
                            Swal.fire({
        ...
        $.ajax({
            ...
            success: function (r) {
                if (r.status == 'error') {
                    ...
                    window.open('../../administrator/pages/pdf/pdf-surat_sakit.php?regis='+no_regis);
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (r) {
                if (r.status == 'error') {
                    ...
                    window.open('../../administrator/pages/pdf/pdf-surat_sehat.php?regis='+no_regis);
                }
            }
        });
    });
            ...
            success: function(r) {
                if (r.status == 'error') {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            document.location.href = '../../administrator/pages/nomor-antrian/index.php?id_pasien=' + r.id_pasien + '&poli=' + r.poli;
                        }
                    });
                }
            }
        ...
        $.ajax({
            ...
            success: function(r) {
                if (r.status == 'error') {
                    ...
                    $.ajax({
                        url: "../../administrator/pages/mailsender/index.php",
                        type: "POST",
                        dataType: "JSON",
                        data: {
                            "regis": r.regis
